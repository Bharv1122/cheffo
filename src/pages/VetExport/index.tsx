      ...
      <PageWrapper>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-[#E7E5E4] pb-4">
            <h1 className="text-2xl font-bold text-[#1C1917]">Homemade Dog Food Review — Chef Doggo</h1>
          ...
          <section className="border-t border-[#E7E5E4] pt-4">
            <p className="text-xs text-[#78716C] leading-relaxed italic">
              This document was generated by Chef Doggo (chefdoggo.app), a homemade dog food planning tool. Chef Doggo provides general educational guidance and does not replace professional veterinary advice. All calorie estimates, portion sizes, and supplement ranges are educational starting points only. A licensed veterinarian or veterinary nutritionist should review all homemade diets before feeding, especially for puppies, seniors, pregnant/nursing dogs, and dogs with medical conditions.
            </p>
          </section>
        </div>
      </PageWrapper>
